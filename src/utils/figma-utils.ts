...
function calculateTranslation(mainComponent: ComponentNode, variantComponent: ComponentNode) {
  ...
  function generateCode(mainComponent: ComponentNode, variantComponent: ComponentNode, translation: { dx: number, dy: number }) {
